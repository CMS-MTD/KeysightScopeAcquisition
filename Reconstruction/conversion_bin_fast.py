...
RawDataLocalCopyPath = '/home/daq/2020_02_cmstiming_ETL/KeySightScope/RawData/'
OutputFilePath = '/home/daq/2020_02_cmstiming_ETL/KeySightScope/RecoData/ConversionRECO/'
...
rawFile4 = RawDataPath + 'Wavenewscope_CH4_'+run+'.bin'
if not os.path.exists(rawFile4):
    sleep(20)
if not os.path.exists(rawFile4):
    sleep(20)
if not os.path.exists(rawFile4):
